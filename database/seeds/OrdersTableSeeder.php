...
class OrdersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $order = Order::create([
            ...
            'billing_address2' => 'Fake Address',
            'billing_city' => 'Fake City',
            'billing_area' => 'Fake Province',
        ...
        $order2 = Order::create([
            ...
            'billing_address1' => 'Fake Address 2',
            'billing_address2' => 'Fake Address 2',
            'billing_city' => 'Fake City 2',
            'billing_area' => 'Fake Province 2',
            //'billing_postalcode' => 'L5B4U2',
            'billing_phone' => '9052145636',
            //'billing_name_on_card' => 'Fake Name on Card',
            //'billing_discount' => 0,
        ...
        $order3 = Order::create([
            ...
            'billing_address1' => 'Fake Address 3',
            'billing_address2' => 'Fake Address 3',
            'billing_city' => 'Fake City 3',
            'billing_area' => 'Fake Province 3',
            //'billing_postalcode' => 'L5B4U2',
            'billing_phone' => '9052145636',
            //'billing_name_on_card' => 'Fake Name on Card',
            //'billing_discount' => 0,
