<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © {{date('Y')}} EDLAC ALGORITHM. All rights reserved.</p>
                <p class="pull-right">Designed by <span><a target="_blank" href="http://edlac.com.ng">Eagles Network</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->