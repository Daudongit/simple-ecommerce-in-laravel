<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © {{date('Y')}} Daud. All rights reserved.</p>
                <p class="pull-right">Powered by <span><a target="_blank" href="mailto:daudonmail@gmail.com">Daudongit</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->